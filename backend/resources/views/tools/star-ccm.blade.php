...
<div class="page-header">
    ...
    <div class="dx-v2-tools-star-header-layout">
        <div class="dx-v2-tools-star-header-icon">
        ...
        <div>
            <h1 class="dx-v2-tools-star-header-title">STAR-CCM+ <span class="vendor-label siemens">Siemens Digital Industries</span></h1>
            <p class="dx-v2-tools-star-header-sub">Simulación multifísica avanzada y Dinámica de Fluidos Computacional (CFD)</p>
        </div>
    </div>
</div>
...
<div class="grid-main" x-data="{ 
    ...
    <div class="main-panel">
        <!-- Bloque 1: Carga -->
        <div class="card mb-4">
            <div class="card-header dx-v2-tools-star-card-header">
                <span class="card-title">Procesamiento de Licencia (cdlmd → saltd)</span>
            ...
            <div class="dx-v2-tools-star-card-body">
                <!-- Error Message Alert -->
                ...
                <form action="{{ route('tools.star-ccm.process') }}" method="POST" enctype="multipart/form-data" id="star-form" @submit.prevent="validateAndSubmit">
                    ...
                    <div class="dx-v2-tools-star-dropzone" 
                         id="dropzone"
                        ...
                        <div class="dx-v2-tools-star-dropzone-content">
                            ...
                            <template x-if="!fileName">
                                <div class="dx-v2-tools-star-dropzone-title">Arrastre archivo .lic aquí o haga clic</div>
                            </template>
                            <template x-if="fileName">
                                <div class="dx-v2-tools-star-dropzone-title" style="color: var(--vendor-siemens, #009999) !important;" x-text="'Seleccionado: ' + fileName"></div>
                            </template>
                            
                            <div class="dx-v2-tools-star-dropzone-subtitle">Daemon detectado: cdlmd</div>
                        </div>
                    ...
                    <div class="dx-v2-tools-star-btn-container">
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-title">Especificaciones STAR-CCM+</span>
            </div>
            <div class="dx-v2-tools-star-card-body">
                <div class="dx-v2-tools-star-specs-grid">
                    <div class="dx-v2-tools-star-specs-column">
                        <div class="dx-v2-tools-star-specs-title">Auditoría IA</div>
                        @foreach([
                        ...
                        <div class="dx-v2-tools-star-spec-row">
                            <code class="dx-v2-tools-star-spec-code">{{ $item[0] }}</code>
                            <div class="dx-v2-tools-star-spec-details">
                                <div class="dx-v2-tools-star-spec-name">{{ $item[1] }}</div>
                                <div class="dx-v2-tools-star-spec-desc">{{ $item[2] }}</div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    <div class="dx-v2-tools-star-specs-column">
                        <div class="dx-v2-tools-star-specs-title">Nomenclatura STAR-CCM+</div>
                        @foreach([
    ...
    <div class="sidebar-panel">
        ...
        <div class="dx-v2-tools-star-sidebar-warning">
            <div class="dx-v2-tools-star-sidebar-warning-header">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                <span class="dx-v2-tools-star-sidebar-warning-title">Aviso de Almacenamiento</span>
            </div>
            <div class="dx-v2-tools-star-sidebar-warning-desc">
        ...
        <div class="dx-v2-tools-star-sidebar-info">
            <div class="dx-v2-tools-star-sidebar-info-text">
                <strong>Transformación SALT:</strong><br>
                - <strong>SERVER PORT:</strong> 29000<br>
                - <strong>VENDOR PORT:</strong> 29001<br>
                - <strong>Daemon:</strong> saltd
            </div>
        </div>
    </div>
</div>
