...
<div class="page-header">
    ...
    <div style="display: flex; align-items: center; gap: 12px; margin-top: 8px;">
        ...
        <div>
            <h1 class="page-title" style="margin: 0;">STAR-CCM+ <span class="vendor-label siemens" style="font-size: 10px; padding: 2px 6px; margin-left: 8px;">Siemens Digital Industries</span></h1>
            <p class="page-sub" style="margin: 0;">Simulación multifísica avanzada y Dinámica de Fluidos Computacional (CFD)</p>
        </div>
    </div>
</div>
                ...
                <form action="{{ route('tools.star-ccm.process') }}" method="POST" enctype="multipart/form-data" id="star-form">
                    ...
                    <div class="dropzone" 
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
                            ...
                            <div class="dropzone-subtext" style="font-size: 11px; opacity: 0.6; color: var(--secondary);">Daemon detectado: cdlmd</div>
                        </div>
        ...
        <div class="card">
            ...
            <div style="padding: 24px;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <div style="font-size: 11px; font-weight: 600; color: var(--muted); text-transform: uppercase; margin-bottom: 4px;">Nomenclatura STAR-CCM+</div>
                        @foreach([
