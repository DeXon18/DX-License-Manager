    ...
    <div class="footer-container">
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-meta">
                <a href="{{ route('pages.ai-privacy') }}" style="color: #059669; font-weight: 600; letter-spacing: 0.5px; display: inline-flex; align-items: center; gap: 5px; text-decoration: none;" title="Declaración de Privacidad y Seguridad IA">
