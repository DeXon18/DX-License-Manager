        ...
        <div style="padding: 24px;">
            <div style="display: flex; align-items: flex-start; gap: 20px;">
                <div style="padding: 15px; border-radius: 10px; background: rgba(67, 97, 238, 0.05); border: 1px solid rgba(67, 97, 238, 0.2); color: var(--accent); flex: 1;">
                    ...
                    <p style="margin: 0; font-size: 12px; line-height: 1.6; opacity: 0.9;">El sistema realiza una copia de seguridad completa automáticamente cada día a las <b>08:10 AM</b>. Los archivos se rotan tras 30 días para optimizar el espacio.</p>
                </div>
