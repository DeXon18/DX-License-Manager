        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 24px; margin-bottom: 24px;">
            ...
            <div class="card" style="height: 100%;">
                ...
                <div class="dx-v2-users-form-body">
                    ...
                    <div class="dx-v2-form-group" x-data="{ active: {{ $user->is_active ? 'true' : 'false' }} }" style="margin-top: 8px; margin-bottom: 0; padding-top: 16px; border-top: 1px solid var(--border);">
            ...
            <div class="card" style="height: 100%;">
                <div class="card-header">
                    <span class="card-title"><i class="fas fa-lock me-2" style="color: var(--primary);"></i> Seguridad (Opcional)</span>
                </div>
                <div class="dx-v2-users-form-body" style="display: flex; flex-direction: column; justify-content: center;">
                    <p class="dx-v2-users-security-desc" style="margin-top: 0; margin-bottom: 24px; font-size: 13px;">Si deseas actualizar la credencial de acceso de este usuario, completa los siguientes campos. Si los dejas en blanco, se mantendrá la contraseña actual.</p>
                    
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div class="dx-v2-form-group" style="margin-bottom: 0;">
                            <label for="password" class="dx-v2-form-label">NUEVA CONTRASEÑA</label>
                            <input type="password" name="password" id="password" class="dx-v2-form-input font-mono" placeholder="••••••••">
                        ...
                        <div class="dx-v2-form-group" style="margin-bottom: 0;">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" class="dx-v2-form-input font-mono" placeholder="••••••••">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div style="border: 1px solid var(--border); border-radius: 8px; overflow: hidden;">
                                ...
                                <div style="padding: 8px 0; background: var(--bg);">
                                    @foreach($perms as $permName => $humanLabel)
                                        @php 
                                            $isChecked = (is_array(old('permissions')) && in_array($permName, old('permissions'))) || (!old('permissions') && $user->hasDirectPermission($permName));
                                        @endphp
